...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fe9d36d934bf90015be4be0
...
To start editing your site, you can use the Sanity interface at https://ggcapital-9d36d.sanity.studio/.
...
Generated at `2020-12-28T12:49:42.180Z` by Stackbit version `0.3.41`.